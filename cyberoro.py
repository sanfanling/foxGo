...
from websgf.cyberoroSgfParser import cyberoroSgfParser
from myThread import getCatalogThread
import sys, os


class cyberoro(websgfUi):
    
    def __init__(self, parent = None):
        super().__init__()
        self.setWindowIcon(QIcon("res/logo.png"))
        self.setWindowTitle(_("Download sgf files from cyberoro"))
